...
```{r timeline, code_folding=TRUE, layout="l-body-outset",fig.width=16,fig.height=4, fig.cap=" Computing landmarks finance and cloud computing.   The data for the cloud computing timeline is sourced from Varghese et al. (2019), while the finance timeline is the authors' calculations"}
library(vistime)
library(ggrepel)
library(ggdark)
library(stringr)
