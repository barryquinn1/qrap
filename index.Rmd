...
```{r timeline, code_folding=TRUE, layout="l-body-outset",fig.width=16,fig.height=3, fig.cap=" Computing landmarks finance and cloud computing.   The data for the cloud computing timeline is sourced from Varghese et al. (2019), while the finance timeline is the authors' calculations"}
library(vistime)
library(ggrepel)
library(ggdark)
library(stringr)
...
p1<-gg_vistime(timeline_data,col.color = "fontcolor") + geom_jitter()
p1
library(highcharter)
...
This has a knock-on effect of challenging students to infer meaning from data and statistics from day one;
...
<aside>
<iframe src="https://player.vimeo.com/video/178485416?h=8a57bf9b88&color=428bca" width="100" height="80" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
</aside>
